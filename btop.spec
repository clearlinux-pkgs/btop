...
Source0  : https://github.com/aristocratos/btop/archive/v1.2.9/btop-1.2.9.tar.gz
...
%prep
%setup -q -n btop-1.2.9
cd %{_builddir}/btop-1.2.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661790121
