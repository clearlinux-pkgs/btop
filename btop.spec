...
Version  : 1.2.12
Release  : 5
URL      : https://github.com/aristocratos/btop/archive/v1.2.12/btop-1.2.12.tar.gz
Source0  : https://github.com/aristocratos/btop/archive/v1.2.12/btop-1.2.12.tar.gz
...
%prep
%setup -q -n btop-1.2.12
cd %{_builddir}/btop-1.2.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665411509
