...
Version  : 1.4.1
Release  : 12
URL      : https://github.com/aristocratos/btop/archive/v1.4.1/btop-1.4.1.tar.gz
Source0  : https://github.com/aristocratos/btop/archive/v1.4.1/btop-1.4.1.tar.gz
...
%prep
%setup -q -n btop-1.4.1
cd %{_builddir}/btop-1.4.1
pushd ..
cp -a btop-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745849805
mkdir -p clr-build
pushd clr-build
