...
Source0  : https://github.com/aristocratos/btop/archive/v1.4.0/btop-1.4.0.tar.gz
...
%prep
%setup -q -n btop-1.4.0
cd %{_builddir}/btop-1.4.0
pushd ..
cp -a btop-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727012738
mkdir -p clr-build
pushd clr-build
